 ...
 * dependência Gradle. Conteúdo idêntico ao original, salvo este comentário. Nota: esta classe
 * grava do mic do CELULAR (MediaRecorder.AudioSource.MIC) internamente — é o que mantém
 * OpenWakeWordDetector.kt coerente com o resto do pacote libras/audio, que também escuta wake
 * word no mic do celular (ver docs/orquestracao-dialogo-audio-plano.md §4 item 1).
 */
