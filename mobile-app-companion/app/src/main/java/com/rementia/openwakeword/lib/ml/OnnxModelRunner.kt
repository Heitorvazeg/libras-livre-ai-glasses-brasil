 ...
 * dependência Gradle. Conteúdo idêntico ao original, salvo este comentário. `modelPath` é o
 * classificador custom por frase (WakeWordModel.modelPath) — os dois `.onnx` treinados pras frases
 * "Libras Livre, iniciar/encerrar" (docs/orquestracao-dialogo-audio-plano.md §4 item 9, §7 Fase 3).
 */
